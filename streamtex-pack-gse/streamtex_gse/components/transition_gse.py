...
Relocated from `streamtex-pack-design` (where it lived from v0.2.0 to
v0.2.5) — see CHANGELOG.
...
| pivot prose | inline_emphasis.strong (+ amber)   |
...
- `logo_uri`: str — defaults to the project-local GSE-One logo path.

### INTERDITS

- Do not use for transitions to other methodologies (use generic
  `narrative_transition` from streamtex-pack-design instead).
...
- Transitions to other methodologies — use `narrative_transition` from
